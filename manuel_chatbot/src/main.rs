...
fn main() {
    ...
    let mut memory = Dict::<String>::new();
...
fn remember(memory: Dict<T>, subject: String, predicate: String) {

}

fn define(memory: &Dict<DictEntry>, word: String) -> String {
    let definition;
    if word == "book" {
...
fn respond_to(memory: Dict<T>, input: &str) -> String{
