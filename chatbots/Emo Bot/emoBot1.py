...
def main():
  ...
  print("hi! My name's EmoBot... here to console you")# but most people call me "+oneFrom(properNouns))

  while True:
    input = raw_input("> ").lower() # this is a random sit on the keyboard string
 #   input = input.
